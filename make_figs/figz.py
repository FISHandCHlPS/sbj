...
g = sns.jointplot(dfx, x="accept", y="change2", hue="type", palette=["red", "blue"], marginal_kws=dict(weights=dfx.weight))
#sns.move_legend(g, loc="upper right", bbox_to_anchor=(0.8, 0.9))
g.plot_joint(sns.kdeplot, levels=3)
#(dfx, x="accept", y="change2", hue="type", palette=["red", "blue"], ax=g.ax, legend=None)
plt.savefig("figs/figz.pdf")
